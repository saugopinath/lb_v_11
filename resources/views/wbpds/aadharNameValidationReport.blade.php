                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-row">
                                ...
                                @if ($is_urban_visible)
                                    <div class="form-group col-md-4">
                                        <label class="control-label">Is Faulty<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group col-md-4" id="divUrbanCode">
                                        <label class="">Rural/ Urban<span class="text-danger"></span></label>
                                ...
                                @if ($block_visible)
                                    <div class="form-group col-md-4" id="divBodyCode">
                                        <label class="" id="blk_sub_txt">Block/Municipality.<span
                                ...
                                <div class="form-group col-md-4" id="municipality_div"
                                    ...
                                    <label class="">Municipality<span class="text-danger">*</span></label>
                    ...
                    <table id="example" class="display data-table table2excel" cellspacing="0" width="100%"
                        ...
                        <thead style="font-size: 12px;">
                            <tr role="row">
                                ...
                                <th>Total Name Mismatch (C)</th>
                                <th>Yet To Be Action Pending (D)</th>
                                <th colspan="2">Processed With Minor Missmatch (E)</th>
                                <th colspan="2">Processed With New Aadhar Info (F)</th>
                                {{-- <th colspan="2">Rejected(G)</th> --}}
                            </tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".exportToExcel").click(function(e) {
                ...
                $(".table2excel").table2excel({
                    ...
                    exclude: ".noExl",
                    name: "Worksheet Name",
                    filename: "Lakshmir Bhander PDS Aadhar Name Validation MIS Report", //do not include extension
            ...
            $('.modal-search').on('click', function() {
                ...
                if ($.trim($('#faulty_type').val()) == '') {

                    error_faulty_type = 'Faulty type is required';
                    $('#error_faulty_type').text(error_faulty_type);
                    $('#faulty_type').addClass('has-error');
                } else {
                    error_faulty_type = '';
                    $('#error_faulty_type').text(error_faulty_type);
                    $('#faulty_type').removeClass('has-error');
                    loadDataTable();
                }
        ...
        function loadDataTable() {
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: '{{ url('aadharNameValidMISPost') }}',
                data: {
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $.each(data.row_data, function(i, item) {
                            ...
                            var total_name_mismatch = isNaN(parseInt(item.total_name_mismatch)) ? 0 :
                                parseInt(item.total_name_mismatch);


                            var total_yet_to_be_action_pending = isNaN(parseInt(item
                                .total_yet_to_be_action_pending)) ? 0 : parseInt(item
                                .total_yet_to_be_action_pending);
                            var total_minor_yet_to_approved = isNaN(parseInt(item
                                .total_minor_yet_to_approved)) ? 0 : parseInt(item
                                .total_minor_yet_to_approved);
                            var total_minor_approved = isNaN(parseInt(item.total_minor_approved)) ? 0 :
                                parseInt(item.total_minor_approved);
                            var total_aadhar_yet_to_approved = isNaN(parseInt(item
                                .total_aadhar_yet_to_approved)) ? 0 : parseInt(item
                                .total_aadhar_yet_to_approved);
                            var total_aadhar_approved = isNaN(parseInt(item.total_aadhar_approved)) ?
                                0 : parseInt(item.total_aadhar_approved);
                            ...
                            fotter_4 = fotter_4 + total_aadhar_yet_to_approved;
                            fotter_5 = fotter_5 + total_aadhar_approved;
                            ...
                            table.append("<tr><td>" + (i + 1) + "</td><td>" + item.location_name +
                                "</td><td>" + total_name_mismatch + "</td><td>" +
                                total_yet_to_be_action_pending + "</td><td>" +
                                total_minor_yet_to_approved + "</td><td>" + total_minor_approved +
                                "</td><td>" + total_aadhar_yet_to_approved + "</td><td>" +
                                total_aadhar_approved + "</td></tr>");
                            //slno++;

                        });

                        $("#example > tfoot #fotter_id").html("<th></th><th>Total</th><th>" + fotter_1 +
                            "</th><th>" + fotter_8 + "</th><th>" + fotter_2 + "</th><th>" + fotter_3 +
                            "</th><th>" + fotter_4 + "</th><th>" + fotter_5 + "</th>");
                        //$('#example tbody').empty();
                        $("#example").show();
