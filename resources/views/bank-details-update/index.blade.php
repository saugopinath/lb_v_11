  ...
  <div class="container-fluid">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1>Update Bank Details For Approved Beneficiary</h1>
          </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default" id="full-content">
          <div class="card-body">
            <div class="card card-default">
              <div class="card-header card-header-custom">
                <h3 class="card-title" id="panel-icon">Enter Beneficiary Details Here</h3>
              </div>
              <div class="card-body">
                <div class="row">
                ...
                <div class="col-md-12">
                  <div class="row align-items-end">
                    ...
                    <div class="col-md-3 mb-1" id="beneficiary_id_div" style="display: none;">
                    ...
                    <div class="col-md-3 mb-1" id="application_id_div" style="display: none;">
                    ...
                    <div class="col-md-3 mb-1" id="sasthyasathi_card_div" style="display: none;">
            ...
            <div class="card card-default" id="listing_div" style="display: none;">
              <div class="card-header card-header-custom" id="panel_head">
        ...
        <div class="modal fade ben_bank_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="accordion" id="bankAccordion">
                  <div class="card">
                    <div class="card-header active" id="personalHeading">
                      <h5 class="mb-0">
                    ...
                    <div id="collapsePersonal" class="collapse show" aria-labelledby="personalHeading" data-bs-parent="#bankAccordion">
                      <div class="card-body p-3">
                        <table class="table table-bordered table-condensed table-striped font-14">
                          <tbody>
                            <tr>
                  ...
                  <div class="card">
                    <div class="card-header" id="bankHeading">
                      <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBank" aria-expanded="false" aria-controls="collapseBank">
                          Update Bank Details
                        </button>
                      </h5>
                    </div>
                    <div id="collapseBank" class="collapse" aria-labelledby="bankHeading" data-bs-parent="#bankAccordion">
                      <div class="card-body">
                        ...
                        <table class="table table-bordered table-responsive" style="width:100%">
                          <tbody>
                            <tr>
                              <th scope="row" class="required font-14">Bank Branch Name</th>
                              <td id="branch_text">
                                <input type="text" value="" name="branch_name" id="branch_name" class="form-control" readonly>
                                <span class=" font-14" id="error_bank_branch" class="text-danger"></span>
                              </td>
                              <th scope="row" class="required font-14">Bank IFSC Code</th>
                              <td id="bank_ifsc_text">
                                ...
                                <span class=" font-14" id="error_bank_ifsc_code" class="text-danger"></span>
                              </td>
                            </tr>
                            <tr>
                              <th scope="row" class="required font-14">Bank Name</th>
                              <td id="bank_text">
                                <input type="text" value="" name="bank_name" maxlength="200" id="bank_name" class="form-control" readonly>
                                <span class=" font-14" id="error_name_of_bank" class="text-danger"></span>
                              </td>
                              <th scope="row" class="required font-14">Bank Account Number</th>
                              <td id="bank_acc_text">
                                <input type="password" value="" name="bank_account_number" maxlength='20' id="bank_account_number" class="form-control">
                                <span class=" font-14" id="error_bank_account_number" class="text-danger"></span>
                              </td>
                            </tr>
                            <tr>
                              <th scope="row" class="required font-14">Confirm Bank Account Number</th>
                              <td colspan="3">
                                <input type="text" name="confirm_bank_account_number" maxlength="20" id="confirm_bank_account_number" value="" class="form-control">
                                <span class=" font-14" id="error_confirm_bank_account_number" class="text-danger"></span>
                              </td>
                            </tr>
                            <!-- Document Update Section -->
                            <tr>
                              <th scope="row" class="required font-14">Upload Bank Passbook</th>
                              <td id="bank_passbook_text">
                                <input type="file" name="upload_bank_passbook" accept=".jpg,.jpeg,.png,.pdf" id="upload_bank_passbook" value="" class="form-control">
                                <span class=" font-14" id="error_file" class="text-danger"></span>
                              </td>
                              <th scope="row" class="required font-14">Copy Of Passbook</th>
                            ...
                            <tr>
                              <th scope="row" class="required font-14">Remarks</th>
                              <td colspan="3">
                                <input type="text" name="remarks" maxlength="100" id="remarks" class="form-control" value="">
                                <span class="font-14" id="error_remarks" class="text-danger"></span>
                              </td>
                            </tr>
                          </tbody>
                        </table>
        ...
        <div class="modal fade ben_mobile_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header singleInfo">
              ...
              <div class="modal-body">
                ...
                <div class="accordion" id="mobileAccordion">
                  <div class="card">
                    <div class="card-header active" id="personalMobileHeading">
                      <h5 class="mb-0">
                        <button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePersonalMobile" aria-expanded="true" aria-controls="collapsePersonalMobile">
                          Personal Details <span class="applicant_id_modal"></span>
                        </button>
                      </h5>
                    </div>
                    <div id="collapsePersonalMobile" class="collapse show" aria-labelledby="personalMobileHeading" data-bs-parent="#mobileAccordion">
                      <div class="card-body p-3">
                        <table class="table table-bordered table-condensed table-striped font-14">
                          <tbody>
                            <tr>
                  ...
                  <div class="card">
                    <div class="card-header" id="mobileHeading">
                      <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMobile" aria-expanded="false" aria-controls="collapseMobile">
                          Update Mobile Number
                        </button>
                      </h5>
                    </div>
                    <div id="collapseMobile" class="collapse" aria-labelledby="mobileHeading" data-bs-parent="#mobileAccordion">
                      <div class="card-body">
                        <p style="font-size: 12px;font-weight: bold; text-align:center;">All (<span style="color:firebrick"> * </span>) marks filled are mandatory</p>
                        <table class="table table-bordered table-responsive" style="width:100%">
                          <tbody>
                            <tr>
                              <th scope="row" class="required font-14">Mobile Number</th>
                              <td id="bank_passbook_text">
                                <input type="text" name="updateMobileNo" id="updateMobileNo" value="" maxlength="10" onkeypress="if ( isNaN(String.fromCharCode(event.keyCode) )) return false;" class="form-control">
                                <span class=" font-14" id="error_update_mobile_no" class="text-danger"></span>
                              </td>
                            </tr>
                            <tr>
                              <th scope="row" class="required font-14">Remarks</th>
                              <td>
                                <input type="text" name="updateMobileRemarks" maxlength="100" id="updateMobileRemarks" class="form-control" value="">
                                <span class=" font-14" id="error_mobile_no_remarks" class="text-danger"></span>
                              </td>
                            </tr>
                          </tbody>
                        </table>
