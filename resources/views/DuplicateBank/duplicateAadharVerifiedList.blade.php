    ...
    <div class="box box-default">
      <div class="box-body">
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><span id="panel-icon"><h4><b>Duplicate Aadhar(Verified)</b></h4></div>
...
<div id="modalConfirmation" class="modal fade">
  <form method="POST" action="{{ route('revertDuplicateVerifiedApprover')}}"  name="fullForm" id="fullForm">
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Do you really want to revert the  application(<span id="application_text"></span>)?</p>
			</div>
			<div class="modal-footer justify-content-center">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
				<button type="submit" class="btn btn-danger modal-submit" >OK</button>
...
$(document).ready(function() {
  ...
  $('.sidebar-menu #dup_aadhar_verified').addClass("active"); 
  var sessiontimeoutmessage='{{$sessiontimeoutmessage}}';
  var base_url='{{ url('/') }}';
  ...
  $('#div_rejection').hide();
   ...
   if ( $.fn.DataTable.isDataTable('#example') ) {
         ...
         dataTable=$('#example').DataTable( {
          ...
          "ajax": 
          {
            url: "{{ url('lb-dup-aadhar-list-verified-approver') }}",
            type: "post",
            data:function(d){
       ...
       "columnDefs": [
          ...
          "buttons": [
           ...
           title: 'Duplicate Aadhar(Verified) Report  <?php echo date('d-m-Y');  ?>',
  ...
  $('#block_ulb_code').change(function() {
    ...
    $('#filter').click(function(){
      ...
      $('#reset').click(function(){
       window.location.href='lb-dup-aadhar-list-verified-approver';  
    });
