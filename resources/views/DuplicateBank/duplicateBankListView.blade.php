    ...
    <div class="box box-default">
      <div class="box-body">
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><span id="panel-icon"><h4><b>Duplicate Bank Account No.</b></h4></div>
          <div class="panel-body" style="padding: 5px; font-size: 14px;">
           ...
           <form action="DupBankAccounttExcelDistrict" method="post">
              ...
              <table id="example" class="display" cellspacing="0" width="100%">
                ...
                <tbody style="font-size: 14px;">
                  ...
                  <tr>
                    ...
                    <td>{{$arr->cnt}}</td>
                   <td><a href="dedupBankView?last_accno={{$arr->last_accno}}"  class="btn btn-primary">De-duplicate</a></td>
                  </tr>
                  @endforeach
                  @else
                  <tr>
