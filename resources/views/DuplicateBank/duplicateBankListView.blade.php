      ...
      <div class="card-body">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h4 class="mb-0"><b>Duplicate Bank Account No.</b></h4>
          </div>
          ...
          <div class="card-body" style="padding:5px; font-size:14px;">
            ...
            <!-- EXCEL DOWNLOAD -->
            <form action="DupBankAccounttExcelDistrict" method="post" class="mb-3">
              @csrf
              <input type="hidden" name="district_code" id="district_code" value="{{ $district_code }}">
              <input type="submit" class="btn btn-info" value="Export All Data to Excel" />
            </form>
                  ...
                  @if(count($data) > 0)
                    @foreach ($data as $arr)
                      <tr>
                        ...
                        <td>{{ $arr->cnt }}</td>
                        <td>
                          <a href="dedupBankView?last_accno={{ $arr->last_accno }}" class="btn btn-primary btn-sm">
                            De-duplicate
                          </a>
                        </td>
                      </tr>
