              ...
              <table id="example" class="display" cellspacing="0" width="100%">
                ...
                <tbody style="font-size: 14px;">
                  ...
                  <tr>
                    <td>{{$arr->bank_ifsc}}</td>
                    <td>{{$arr->bank_code}}</td>
                    <td><a href="dedupBankView?bank_ifsc={{$arr->bank_ifsc}}&bank_code={{$arr->bank_code}}" class="btn btn-primary">De-duplicate</a></td>
                  </tr>
                  @endforeach
                  @else
                  <tr>
                    <td colspan="3">No Duplicate Record Found.</td>
                  </tr>
                  @endif
                </tbody>
              </table>
