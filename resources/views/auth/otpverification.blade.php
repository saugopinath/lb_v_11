    ...
    <x-success class="mt-6" />
       ...
       <div class="row justify-content-center mt-4">
                <div class="col-md-3 col-sm-6 p-4">
                    <form method="POST" action="{{ route('otp-validate-post') }}" class="form-horizontal">
                        {{ csrf_field() }}
                  ...
                  <input type="hidden" name="token_id" value="{{ Crypt::encrypt($user_id) }}">
                   <input type="hidden" name="source_type" value="{{ Crypt::encrypt($source_type) }}">
                        <div class="mb-3 text-center">
                            <input id="otp" type="text" maxlength="10" class="form-control text-center mx-auto"
                                name="otp" placeholder="Enter OTP"  autofocus autocomplete="off">
                        </div>
