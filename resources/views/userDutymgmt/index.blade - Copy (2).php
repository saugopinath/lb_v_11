            ...
            <div id="scheme_workflow" class="panel-collapse collapse show">
              <div class="panel-body" id="level_map"> <!-- hidden by default-->
                ...
                <div class="col-md-12 pull-right" id="addButton">
                   ...
                   @if($designation_id=='HOD' || $designation_id=='Verifier' || $designation_id=='Approver' )
    ...
    <div class="modal-content">
             ...
             <div class="row">
              ...
              <div class="row">   
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-4 forAddUserOnly" id="role_id_user_div">
                            <label for="role_id_adduser" class="control-label">Role <span class="requied">*</span></label>

                           
                                <select id="role_id_user"  class="form-control" name="role_id_user" onChange="handleChangeUserType(this.value,'user')">
     ...
     <div class="row">
      ...
      <div class="form-group col-sm-3"  id="block_munc_corp_code_user_div" style="display:none;" style="width:200px;">
              <label for="block_munc_corp_code_user" class="">Block <span class="requied">*</span></label>
      ...
      <div class="modal-footer">
        ...
        <span class="crud-txt">Add</span>
         ...
         <img  style="display:none;" src="{{ asset('images/ZKZg.gif')}}" id="btn_addEdit_loader" width="150px"
                            height="150px">
...
<div id="dutyAssignmentModal" class="modal fade">
    ...
    <input type="hidden" name="user_id" id="user_id"/>
     <input type="hidden" name="role_id_duty" id="role_id_duty"/>
	  {{ csrf_field() }}  
				<div class="modal-header">						
    ...
    <div class="row">
      ...
      <div class="form-group col-sm-3"  id="block_munc_corp_code_duty_div" style="display:none;">
              <label for="l_block_munc_corp_code_duty" class="">Block <span class="requied">*</span></label>
...
function reloadDesignation(stake_level,divId)
{
  ...
  $("#btn-submit").click(function(){
    ...
    $designation_id = $('#role_id_user option:selected').val();
    //alert($service_designation_id);
  ...
  function dutyAssignment(id,username,designation_id){
    $("#scheme_duty").empty();
    $("#role_id_duty").val('');
   ...
   // alert(username);
    $("#user_id").val(id);
    $("#role_id_duty").val(designation_id);
    ...
    if(district_code!=''){
      ...
      var is_urban=$("#is_urban_user").val();
        ...
        loadSubdiv(district_code,divId);
          ...
          $("#is_urban_"+divId).val('');
          $("#block_munc_corp_code_"+divId).html('<option value="">Select Block</option>');
         // $("#is_urban_"+divId).val('');
...
function handleChangeUserType(designation_id,divId){
 //alert(designation_id);
    if(designation_id!=''){
      $('#role_id_user_ajax').html('<img src="{{ asset('images/ZKZg.gif') }}" width="50px" height="50px"/>');
       $.ajaxSetup({
      headers: {
          'X-CSRF-TOKEN': "{{csrf_token()}}"
      }
      ...
      success: function(data) {
        ...
        if(data.return_msg=='yes'){
          ...
          $('#must_role_adduser').val(0);
        }
         $('#maping_level_user').val('');
         $('#role_id_user_ajax').html('');
      }
      else{
        alert('Error Occur .. Please try again');
      }
