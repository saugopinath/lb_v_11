                ...
                success: function (data) {
                  ...
                  //  var fotter_6=0;var fotter_7=0;
                   $.each(data.row_data, function(i, item) {
                     ...
                     var approved_f = isNaN(parseInt(item.approved_f)) ? 0 : parseInt(item.approved_f);
                    ...
                    //  fotter_7=fotter_7+verified_sum;
                     ...
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.block_subdiv_name+"</td><td>"+total_submitted+"</td><td>"+verification_pending+"</td><td>"+verified+"</td><td>"+total_approved+"</td><td>"+rejected+"</td></tr>");
                      //slno++;
