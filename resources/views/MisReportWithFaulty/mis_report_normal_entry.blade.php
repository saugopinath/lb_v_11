            ...
            <div class="card-body" style="padding: 15px;">
                ...
                <div class="filterDiv">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="required-field">From Date(Application Submission Date)</label>
                                <input type="date" class="form-control" name="from_date" id="from_date">
                                <span id="error_from_date" class="text-danger"></span>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="required-field">To Date(Application Submission Date)</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".exportToExcel").click(function(e) {
                ...
                $(".table2excel").table2excel({
                    ...
                    exclude: ".noExl",
                    name: "Worksheet Name",
                    filename: "Lakshmir Bhandar Application Drill Down Report", //do not include extension
            ...
            $('.modal-search').on('click', function() {
                ...
                //     $('#error_urban_code').removeClass('has-error');
                // } else {
                ...
                if (error_ds_phase != '' || error_from_date != '' || error_to_date != '') {
                    return false;
                } else {
                    loadDataTable();
                }
        ...
        function loadDataTable() {
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: '{{ url('misReportWithNormalPost') }}',
                data: {
                    ds_phase: ds_phase,
                    district: district,
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $.each(data.row_data, function(i, item) {
                            var total_submitted = isNaN(parseInt(item.total_application_submitted)) ?
                                0 : parseInt(item.total_application_submitted);
                            ...
                            var total_approved = approved + approved_f;

                            fotter_1 = fotter_1 + total_submitted;
                            fotter_2 = fotter_2 + verification_pending;
                            fotter_3 = fotter_3 + verified;
                            fotter_4 = fotter_4 + total_approved;
                            fotter_5 = fotter_5 + rejected;
                            //  fotter_6=fotter_6+verified_sum_n_f;
                            //  fotter_7=fotter_7+verified_sum;

                            table.append("<tr><td>" + (i + 1) + "</td><td>" + item.block_subdiv_name +
                                "</td><td>" + total_submitted + "</td><td>" + verification_pending +
                                "</td><td>" + verified + "</td><td>" + total_approved +
