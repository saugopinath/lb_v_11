                        ...
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="cars" class="required-field">Please Choose:</label>
                                    <select name="ds_phase" id="ds_phase" class="form-control">
                                        ...
                                        <optgroup label="Form through Duare Sarkar camp">
                                            @foreach ($ds_phase_list as $ds_row)
                                                <option value="{{ $ds_row->phase_code }}"
                                                    @if ($ds_row->is_current == true) selected @endif>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" align="center">
                                ...
                                {{-- <button type="button" id="submitting" value="Submit"
                                    class="btn btn-success success btn-lg modal-search form-submitted">Search </button>
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $.each(data.row_data, function(i, item) {
                            ...
                            var verification_pending = isNaN(parseInt(item.verification_pending)) ? 0 :
                                parseInt(item.verification_pending);
                            var verification_pending_faulty = isNaN(parseInt(item
                                .verification_pending_faulty)) ? 0 : parseInt(item
                                .verification_pending_faulty);

                            var verified = isNaN(parseInt(item.verified)) ? 0 : parseInt(item.verified);
                            var verified_faulty = isNaN(parseInt(item.verified_faulty)) ? 0 : parseInt(
                                item.verified_faulty);

                            var approved = isNaN(parseInt(item.approved)) ? 0 : parseInt(item.approved);
                            var approved_faulty = isNaN(parseInt(item.approved_faulty)) ? 0 : parseInt(
                                item.approved_faulty);
                            ...
                            var total_faulty = isNaN(parseInt(item.total_faulty)) ? 0 : parseInt(item
                                .total_faulty);

                            var total_n_f = total + total_faulty + verified_sum_faulty +
                                verification_pending_faulty;
                            var verified_sum_n_f = verified_sum + verified_sum_faulty;
                            var verified_n_f = verified + verified_faulty;
                            var verification_pending_n_f = verification_pending +
                                verification_pending_faulty;
                            ...
                            table.append("<tr><td>" + (i + 1) + "</td><td>" + item.location_name +
                                "</td><td>" + total_n_f + "</td><td>" + total + "</td><td>" +
                                total_faulty + "</td><td>" + partial + "</td><td>" + full +
                                "</td><td>" + verified_sum_n_f + "</td><td>" + verified_sum +
                                "</td><td>" + verified_sum_faulty + "</td><td>" +
                                verification_pending_n_f + "</td><td>" + verification_pending +
                                "</td><td>" + verification_pending_faulty + "</td><td>" +
                                verified_n_f + "</td><td>" + verified + "</td><td>" +
                                verified_faulty + "</td><td>" + approved_n_f + "</td><td>" +
                                approved + "</td><td>" + approved_faulty + "</td><td>" + reverted +
                        ...
                        $("#example > tfoot #fotter_id").html("<th></th><th>Total</th><th>" + fotter_1 +
                            ...
                            "</th><th>" + fotter_5 + "</th><th>" + fotter_6 + "</th><th>" + fotter_7 +
                            "</th><th>" + fotter_8 + "</th><th>" + fotter_9 + "</th><th>" + fotter_10 +
                            "</th><th>" + fotter_11 + "</th><th>" + fotter_12 + "</th><th>" + fotter_13 +
                            "</th><th>" + fotter_14 + "</th><th>" + fotter_15 + "</th><th>" + fotter_16 +
                            "</th><th>" + fotter_17 + "</th><th>" + fotter_18 + "</th><th>" + fotter_19 +
                            "</th>");
                        //$('#example tbody').empty();
                        $("#example").show();
