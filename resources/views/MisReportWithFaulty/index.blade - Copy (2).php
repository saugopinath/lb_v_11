...
<button class="exportToExcel" type="button">Export to XLS</button><br/><br/><br/>
<div id="divScrool">   <table class="table table-striped table-bordered table-responsive"  id="table2excel" >
             <thead>
              <tr >
              <td colspan="21" align="center">Heading</td>
              </tr> 
              <tr> 
