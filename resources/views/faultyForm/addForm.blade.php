          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <div class="box-header with-border">
                <h3 class="box-title"><b>Government of West Bengal Lakshmir Bhandar Scheme</b></h3>
                 ...
                 <input type="hidden" name="max_tab_code" id="max_tab_code" value="{{ $max_tab_code }}">
                  ...
                  <div class="tab-pane" id="personal_details">
                    <div class="panel panel-default">
                     ...
                     <form name="personal" id="personal" method="get" action="{{url('ajax_personal_entry_wtSws')}}">

                     <input type="hidden" name="personalCount" id="personalCount" value="">
                     ...
                     <div class="form-group col-md-4">
                          <label class="required-field">Duare Sarkar Registration no.</label>
                           <input type="text" name="duare_sarkar_registration_no" id="duare_sarkar_registration_no" class="form-control NumOnly"
                              placeholder="Duare Sarkar Registration no." maxlength="20" value="" tabindex="5" />
                         ...
                         <div class="form-group col-md-4">
                          ...
                          <input type="date" name="duare_sarkar_date" id="duare_sarkar_date" class="form-control"
                              placeholder="Duare Sarkar Date"  max="<?php echo date("Y-m-d"); ?>" value="" tabindex="10" />
                         ...
                         <div class="form-group col-md-4">
                            ...
                            <input type="text" name="aadhar_no" id="aadhar_no" class="form-control NumOnly"
                              placeholder="Aadhar No." maxlength="12" value="" tabindex="15" />
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                          ...
                          <input  type="text" name="first_name" id="first_name" class="form-control txtOnly"
                            placeholder="Full Name" maxlength="200" value="" tabindex="5" />
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="father_last_name" id="father_last_name" class="form-control txtOnly"
                            placeholder="Last Name" maxlength="200" value=""
                            tabindex="45" />
                       ...
                       <div class="form-group col-md-4" id="caste_certificate_no_section">
                           ...
                           <input type="text" name="caste_certificate_no" id="caste_certificate_no" class="form-control"
                            placeholder="SC/ST Certificate No." maxlength="200" value=""
                            tabindex="117" />
                          ...
                          <div class="form-group col-md-4">
                            <label class="required-field">District</label>
                             ...
                             @foreach ($district_list as $dist)
                               <option value="{{$dist->district_code}}" @if($dist->district_code==$sel_district_code) selected @endif>{{trim($dist->district_name)}}</option>
                        ...
                        <div class="row">
                         <div class="form-group col-md-4">
                          ...
                          <div class="form-group col-md-4" id="divUrbanCode">
                            ...
                            <option value="{{$key}}" @if($sel_rural_urban_id==$key) selected @endif>{{$val}}</option>
                            @endforeach     
                  ...
                  <span id="error_urban_code" class="text-danger"></span>
                          ...
                          <div class="form-group col-md-4" id="divBodyCode">
                            ...
                            <select name="block" id="block" class="form-control"
                             ...
                             @foreach ($block_ulb_list as $block)
                               <option value="{{$block->block_ulb_code}}" @if($sel_block_code==$block->block_ulb_code) selected @endif>{{trim($block->block_ulb_name)}}</option>
                        ...
                        <div class="row">
                            ...
                            @if(count($gp_ward_list)>0)
                             @foreach ($gp_ward_list as $gp)
                               <option value="{{$gp->gp_ward_code}}">{{trim($gp->gp_ward_name)}}</option>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="village" name="village" class="form-control special-char"
                              placeholder="Village/Town/City" maxlength="300" value="" tabindex="160">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="house_premise_no" name="house_premise_no" class="form-control special-char"
                              placeholder="House / Premise No." maxlength="300" value="" tabindex="165">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="post_office" name="post_office" class="form-control special-char"
                              placeholder="Post Office" maxlength="300" value="" tabindex="170">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pin_code" name="pin_code" class="form-control NumOnly"
                              placeholder="Pin Code" maxlength="6" value="" tabindex="175">
                  ...
                  <div class="tab-pane" id="bank_details">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                       ...
                       <input type="hidden" name="bankCount" id="bankCount" value="">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control special-char"
                           autocomplete="off" placeholder="IFSC Code" onkeyup="this.value = this.value.toUpperCase();"
                            value="" maxlength='11' tabindex="200" />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="name_of_bank" id="name_of_bank" class="form-control special-char"
                             placeholder="Bank Name" value="" maxlength="200" tabindex="205"
                            readonly />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="bank_branch" id="bank_branch" class="form-control"
                             placeholder="Bank Branch Name" value="" maxlength="300" tabindex="210"
                            readonly />
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="password" name="bank_account_number" id="bank_account_number"
                            class="form-control NumOnly" placeholder="Bank Account No"
                              autocomplete="off" value="" maxlength='16' tabindex="215" />
                    ...
                    {{ csrf_field() }}
                        <div class="row">
                          ...
                          <div class="form-group col-md-12" tabindex="360">
                            ...
                            <label>
                              <input type="checkbox" class="" name="is_resident" id="is_resident" value="1" >That I am a resident of West Bengal
                               <br/>
                              <span id="error_is_resident" class="text-danger"></span>
                            </label>
                            <br/>
                            <label>
                              <input type="checkbox" class="" id="earn_monthly_remuneration" name="earn_monthly_remuneration" value="1" >That I do not earn any monthly remuneration from any regular Government job
                               <br/>
                              <span id="error_earn_monthly_remuneration" class="text-danger"></span>
                            </label>
                             <br/>
                           <label>
                              <input type="checkbox" class="" id="info_genuine_decl" name="info_genuine_decl" value="1" >That all the information and documents submitted by me are correct/ genuine. In case any of the
