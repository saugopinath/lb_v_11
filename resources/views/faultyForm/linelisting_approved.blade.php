      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body ben_view_body">
           ...
           <tr>       
           <th scope="row">Duare Sarkar Registration no.</th><td id='duare_sarkar_registration_no'></td>
          ...
          <tr>
           ...
           <div class="preloader1"><img src="{{ asset('images/ZKZg.gif') }}" class="loader_img" width="150px" id="loader_img_encolser"></div>
            ...
            <div class="panel-body">   
            <table id="enCloserTable"><tbody></tbody></table>
            </div> 
            </div> 
            </div> 
            </div> 
             ...
             <option value="A" selected="">Approve</option>
              @endif
             <option value="R">Rejected</option><option value="T">Reverted</option></select></div> 
             <div class="form-group col-md-4" style="display:none;" id="div_rejection">
             <label class="required" for="reject_cause">Select Reject/Reverted Cause</label>
          ...
          <div class="modal-footer">
            ...
            <form method="POST" action="{{ route('application-details-read-only')}}" target="_blank" name="fullForm" id="fullForm">
              ...
              <button type="submit" style="float: left" class="btn btn-primary singleInfo">View Full Details</button>
        ...
        success: function (data) {
           if(data.return_status){
            ...
            $("#submitting").hide();
               ...
               alert('Duplicate Bank Info.. Please Check.');
               window.location.href=base_url;
          ...
          error: function (jqXHR, textStatus, errorThrown) {
            $.confirm({
                    ...
                    type: 'red',
                    icon: 'fa fa-warning',
                    content: 'Duplicate Bank Info.. Please Check.',
                    buttons: {
                    Ok: function(){
                     location.reload();
                    }
