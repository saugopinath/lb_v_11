...
@endif -->
                            ...
                            <div class="tab-pane active" id="personal_details">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4><b>CMO Grievance MIS Report </b></h4>
                                    </div>
                    ...
                    <select name="process_type" id="process_type" class="form-control" tabindex="6" >
                        <option value="">--Select--</option>
                        <option value="1">Non Verified</option>
                    ...
                    <span id="error_process_type" class="text-danger"></span>
                                            ...
                                            <div class="col-md-12" align="center">
                                                ...
                                                <button type="button" id="submitting" value="Submit"
                                                    class="btn btn-success  modal-search form-submitted">Search
                                                </button>
                                                {{-- <button style="float: right;"  type="button"  id="submitting" value="Submit" class="btn btn-info " onclick="window.location.href='{{ url('caste-wise-list-report')}}'"><i class="fa fa-users"></i>Caste Wise beneficiary List</button> --}}
                                    ...
                                    <div class="tab-pane active" id="search_details" style="display:none;">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="pull-right" id="report_generation_text">Report Generated
                                                    on:<b><?php echo date('l jS \of F Y h:i:s A'); ?></b></div>

                                                <button class="btn btn-info exportToExcel" type="button">Export to
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="21" align="center"
                                                                    style="display:none;" id="heading_excel">Heading
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th id="">Sl No.(A)</th>
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <tr>
                                                                <td colspan="7" align="center"
                                                                    style="display:none;" id="fotter_excel">Heading
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $.each(data.row_data, function(i, item) {
                            var total_grievance = isNaN(parseInt(item.total_grievance)) ? 0 : parseInt(
                                item.total_grievance);
                            var total_verification_pending = isNaN(parseInt(item
                                .total_verification_pending)) ? 0 : parseInt(item
                                .total_verification_pending);
                            ...
                            var total_approved = isNaN(parseInt(item.total_approved)) ? 0 : parseInt(
                                item.total_approved);
                            var total_grievance_back = isNaN(parseInt(item.total_grievance_back)) ? 0 :
                                parseInt(item.total_grievance_back);
                            ...
                            table.append("<tr><td>" + (i + 1) + "</td><td>" + item.location_name +
                                "</td><td>" + total_grievance + "</td><td>" +
                                total_verification_pending + "</td><td>" + total_verified +
                                "</td><td>" + total_approved + "</td><td>" + total_grievance_back +
                                "</td></tr>");
                            //slno++;
