            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               <div class="panel-heading"><h4><b>CMO Grievance MIS Report </b></h4></div>
            ...
            <input type="hidden" name="urban_code" id="urban_code" value="{{$rural_urban_fk}}"/>
              ...
              @endif
                <div class="col-md-12" align="center">
                  ...
                  <button type="button"  id="submitting" value="Submit" class="btn btn-success  modal-search form-submitted" >Search </button>
