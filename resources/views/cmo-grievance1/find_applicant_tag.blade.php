                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            ...
                                            <div class="col-md-3">
                                                <strong>Age : </strong>
                                                <span style="font-size: 14px;">{{ $atr_details->applicant_age }}
                                                    years</span>
                                            </div>
                                        </div>
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <div class="col-md-12">
                                                ...
                                                <span
                                                    style="font-size: 14px;">{{ $atr_details->grievance_description }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body" style="padding: 5px;">
                                ...
                                <div class="col-md-12" style="margin-bottom: 10px;">
                                    <div class="col-md-3">
                                        ...
                                        <span
                                            style="font-size: 14px;">{{ date('d/m/Y', strtotime($ben_tag_details->dob)) }}</span>
                                    </div>
                                    <div class="col-md-3">
                                        <strong>Father's Name : </strong>
                                        <span style="font-size: 14px;">{{ trim($ben_tag_details->father_fname) }}
                                            {{ trim($ben_tag_details->father_mname) }}
                                            {{ trim($ben_tag_details->father_lname) }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <span
                                            style="font-size: 14px;">{{ trim($ben_contact_details->block_ulb_name) }}</span>
                                    </div>
                                    <div class="col-md-3">
                                        <strong>GP/Ward No : </strong>
                                        <span
                                            style="font-size: 14px;">{{ trim($ben_contact_details->gp_ward_name) }}</span>
                                    </div>
                                </div>
                    ...
                    <div class="row text-center">
                        <div class="col-md-6 col-md-offset-3 mx-auto">
                            <div class="btn-group-wrapper">
                                <!-- Approve Form -->
                                <form method="post" action="{{ route('cmo_grivance_approve1') }}"
                                    id="grivance_approval_form" class="btnJb">
                                    {{ csrf_field() }}
                                    ...
                                    <button style="display:none;" type="button" id="submittingapprove"
                                ...
                                <!-- Revert Form -->
                                <form method="post" action="{{ route('cmo_grivance_revert1') }}"
                                    id="grivance_approval_form_revert" class="btnJb">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="grivance_id" value="{{ $grievance_id }}">
                                    <button type="button" class="btn btn-danger" id="confirm_revert">Revert</button>
                                    <button style="display:none;" type="button" id="submittingapprove_revert"
                                        class="btn btn-info btn-lg" disabled>
                                        Submitting please wait
                                    </button>
                                </form>
