          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-3 mb-3">
                  <label for="gp_ward_code" class="form-label">Wards</label>
...
<script>
  $(document).ready(function() {
    ...
    $('#block_ulb_code').change(function() {
      var block_ulb_code = $(this).val();
      $('#gp_ward_code').html('<option value="">--Select --</option>');
      var htmlOption = '<option value="">--Select--</option>';
      $.each(ulb_wards, function(key, value) {
        if ((value.urban_body_code == block_ulb_code)) {
