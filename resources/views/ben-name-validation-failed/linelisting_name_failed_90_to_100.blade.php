                ...
                <div class="modal-body">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div style="font-size: 16px; text-align: center; ">Name As in Portal :- <b><span
                                id="name_as_in_portal" class="text-danger"></span></b></div>
                            <div style="font-size: 16px; text-align: center; ">Name Response from Bank :- <span
                                    id="name_response" class="text-success"></span></div>
                            <div style="font-size: 16px; text-align: center; ">Name Matching Score:- <b><span id="matching_score" class="text-info"></span>%</b></div>
                            <div style="font-size: 14px; font-weight: bold; font-style: italic; display: none; text-align:center;"class="text-warning" id="note_msg">If minor mismatch is selected then beneficiary name as in portal will be replace with name response from bank after approval.</div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="documentSectionHideShow" style="display: none;">
                                        <th scope="row" class="required" style="font-size: 14px;"><span
                                                id="upload_text">Upload Enquiry Report</span></th>
                                        <td id="bank_passbook_text">
                                            <input type="file" name="upload_enquiry_report"
                                                accept=".jpg,.jpeg,.png,.pdf" id="upload_enquiry_report" value="">
                            ...
                            <div class="row" id="otp_div" style="display: none;">
                                ...
                                <div class="form-group col-md-4">
                                    <input type="text" name="otp" id="otp" maxlength="6"
                                        placeholder="Enter Last Login OTP" class="form-control">
                            ...
                            <div class="row" id="finalUpdatediv" style="display: none;">
                                <div class="col-md-12" style="text-align: center;"><input type="button" name="submit"
                                        value="Send to Approval" id="" class="btn btn-success btn-lg verifySubmit"></div>
                            </div>
                        </div>
                    </div>
                </div>
