                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body ben_view_body">
                            ...
                            <div class="panel-group">
                                ...
                                class="text-warning" align="center">Please select the option to process ?</div>
                                            <div class="form-group col-md-6" style="padding: 5px 5px 5px 5px; border: 1px solid whitesmoke; border-radius: 5px; margin: 5px 0px; background-color: whitesmoke; display: none;" id="div_overule">
                                                <label style="cursor: pointer; margin-bottom: 5px;" class="minor_process">
                                                    <input type="radio" name="process_type" id="process_type" value="11"> Minor
                                                    mismatch, Keep existing bank information
                                                </label><br />
                                                {{-- <label style="cursor: pointer; margin-bottom: 5px;">
                                                    <input type="radio" name="process_type" id="process_type" value="12"> Process
                                                    with new bank information
                                                </label><br /> --}}
                                                <label style="cursor: pointer; margin-bottom: 5px;" class="reject_process">
                                                    <input type="radio" name="process_type" id="process_type" value="13">
                                                    Application is rejected due to major mismatch
                                                </label><br />
                                                <span class="text-danger" id="error_process_type"></span>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label class="" for="heading" id="remarks_heading">Enter Remarks<span class="text-danger">
                                                    *</span></label>
                                            ...
                                            <div id="otp_div">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <button class="btn btn-primary" id="otp_verify"
                                                        name="otp_verify">Verify</button> <span style="margin-left: 10px; font-weight: bold;" id="verification_result"
                            ...
                            <form method="POST" action="#" target="_blank" name="fullForm" id="fullForm"
                                style="text-align: center; align-content: center; display: none;">
