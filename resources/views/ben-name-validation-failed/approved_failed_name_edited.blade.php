...
@section('content')
    ...
    <!-- <div class="content-wrapper"> -->
        ...
        <section class="content-header">
            <h1>Approve Edited Name Details</h1>
        </section>
        ...
        <section class="content">
                ...
                <div class="card-body">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="row g-2">
                                <div class="col-md-4">
                                    <label class="control-label">
                                        Edited Type by Verifier <span class="text-danger">*</span>
                                    </label>
                                    <select name="update_code" id="update_code" class="form-control">
                                        <option value="">-----Select----</option>
                                        <option value="12">Process with new bank account</option>
                                        <option value="13">Application is rejected due to major mismatch</option>
                                    </select>
                                </div>
                            ...
                            <!-- BULK ACTION BUTTON -->
                            <div class="row">
                                <div class="col-md-3 offset-md-4" id="approve_rejdiv" style="display:none;">
                                    <button type="button" class="btn btn-success btn-lg" id="bulk_approve" value="approve">
                                        Approve
                                    </button>
                                </div>
                            </div>
                                ...
                                <table id="example" class="table table-bordered table-striped w-100">
                                    <thead style="font-size: 12px;">
                                        <tr>
                                            ...
                                            <th>Edited Type</th>
                                            <th>Action</th>
                                            <th>Check <input type="checkbox" id="check_all_btn"></th>
                                        </tr>
                                    </thead>
            ...
            <!-- MODAL START -->
            <div class="modal fade ben_view_modal" id="benViewModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ben_view_body">
                            ...
                            <div class="card mb-2">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <img src="" id="loader_img_personal" width="120px" />
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select id="opreation_type" name="opreation_type" class="form-control">
                                        ...
                                        <div class="col-md-4" id="div_rejection" style="display:none;">
                                            ...
                                            <select id="reject_cause" name="reject_cause" class="form-control">
                                                <option value="">--Select--</option>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <textarea class="form-control" id="accept_reject_comments"
                                    ...
                                    <!-- OTP SECTION -->
                                    <div class="row mt-3" id="otp_div" style="display:block;">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            ...
                                            <span id="verification_result" class="ms-2"></span>
                                        </div>
                                    </div>
                            ...
                            <!-- Hidden Form -->
                            <form method="POST" action="#" target="_blank" id="fullForm" style="display:none;">
                                ...
                                <button type="button" class="btn btn-success btn-lg mt-2" id="verifyReject">Approve</button>
                                <button type="button" class="btn btn-success mt-2" id="submitting" disabled
                                    style="display:none;">
    ...
    <script>
        $(document).ready(function () {
            ...
            var dataTable = $('#example').DataTable({
                ...
                ajax: {
                    url: "{{ url('getEditedNameFailedDetailsData') }}",
                    type: "POST",
                    data: function (d) {
                ...
                "buttons": [{
                    extend: 'pdf',
                    title: "Approve Edited Bank Details  Report Generated On-@php
        ...
        $(document).on('click', '.ben_view_button', function () {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('getEditFailedNameData') }}",
                data: {
                    _token: '{{ csrf_token() }}',
                    benid: benid
                },
        ...
        $(document).on('click', '#verifyReject', function () {
            ...
            if ($.trim($('#accept_reject_comments').val()).length == '') {
                error_accept_reject_comments = 'Operation type required';
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: "{{ url('updateFailedNameFromApprover') }}",
                                    data: {
