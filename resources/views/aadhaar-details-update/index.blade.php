...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Update Aadhaar Details For Approved Beneficiary
    </h1>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body" style="padding: 5px;">
            ...
            <div class="row">
             ...
             <form name="casteManagement" id="casteManagement" method="post" action="{{url('aadhaar-details-update')}}" onsubmit="return validate();" >
              {{ csrf_field() }}
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group col-md-3" id="beneficiary_id_div">
                  ...
                  onkeypress="if ( isNaN(String.fromCharCode(event.keyCode) )) return false;" placeholder="Enter Beneficiary ID" value="{{$fill_array['ben_id']}}" autocomplete="off">
              ...
              <table id="example" class="table table-striped" cellspacing="0" width="100%">
                ...
                @foreach ($result as $row)
                  ...
                  <td>
                   ...
                   <a class="btn btn-info btn-sm" href="{{url('changeAadhar')}}?id={{$row['beneficiary_id']}}&is_faulty={{intval($row['is_faulty'])}}"><i class="fa fa-edit"></i> Aadhar Info Change</a>
