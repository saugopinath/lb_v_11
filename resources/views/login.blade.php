        ...
        <div class="inner-container">
            ...
            <div class="row align-items-center mt-4">
                <div class="col-md-2 col-sm-3 text-center">
                    <img src="images/biswo.png" alt="Logo" class="img-fluid biswo">
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-center">
                            ...
                            <div class="text-center">
                                <a href="{{ route('track-applicant-public') }}" class="btn btn-info d-inline-flex align-items-center justify-content-center gap-2 px-4 py-2 rounded-pill shadow-sm fw-semibold" style="min-width: 230px;">
                    ...
                    <form method="POST" action="{{ route('loginPost') }}" class="form-horizontal">
                        ...
                        <div class="mb-3 text-center">
                            <input id="login_password" type="password" class="form-control text-center mx-auto"
                                name="login_password" placeholder="Enter Password"  autocomplete="off">
                        </div>

                        <div class="d-grid mb-2">
                            <button type="submit" class="btn btn-success">Login1</button>
                        </div>
