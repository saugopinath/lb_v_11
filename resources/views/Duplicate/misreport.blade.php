                    ...
                    <div class="tab-content" style="margin-top:16px;">
                        <div class="tab-pane active" id="personal_details">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h4><b>Aadhar DeDuplication Mis Report</b></h4></div>
                                        ...
                                        <div class="row">          
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" align="center">
                                                    ...
                                                    <button style="float: right;"  type="button"  id="submitting" value="Submit" class="btn btn-info"  onclick="window.location.href='{{route('dup-aadhar-ben-list')}}'"><i class="fa fa-users"></i> Duplicate Aadhar Info Beneficiary List</button>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                {{-- @if($designation_id=='Approver')
                                                    <form action="applicationListNoaadharExcel" method="post" id="formexcel">
                                                        ...
                                                        <input type="submit" name="submit" id="excel" class="btn btn-success" value="Export All Data to Excel"/>
                                                    </form>  
                                                @endif --}}
                                                <br/>
                                                <div id="divScrool"> 
                                                    <table id="example" class="table table-striped table-bordered table2excel" style="width:100%">
                                                        <thead>
                                                            ...
                                                            <tr> 
                                                                ...
                                                                <th>Total Duplicate(C)</th> 
                                                                <th>Approval Pending/Verified(D)</th>
                                                                <th>Verified & Approved(E)</th>
                                                                <th>Total(F)</th> 
                                                            </tr> 
                                                        </thead>
                                                        <tbody> 
...
$(document).ready(function(){
    ...
    $('.sidebar-menu #deDuplicateAadhaarMisReport').addClass("active"); 
  //loadDataTable();
  $(".exportToExcel").click(function(e){
    ...
    exclude: ".noExl",
    name: "Worksheet Name",
    filename: "Lakshmir Bhandar No Aadhaar Mis Report "+c_time, //do not include extension
                ...
                success: function (data) {
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     var total_duplicate = isNaN(parseInt(item.total_duplicate)) ? 0 : parseInt(item.total_duplicate);
                    ...
                    //  var approved = isNaN(parseInt(item.approved)) ? 0 : parseInt(item.approved); 
                     var approved_deduplication = isNaN(parseInt(item.approved_deduplication)) ? 0 : parseInt(item.approved_deduplication); 
                     var total=total_duplicate+approval_pending+approved_deduplication;
                    //  fotter_1= fotter_1 + total;               
                     fotter_1=fotter_1+total_duplicate;
                     fotter_2=fotter_2+approval_pending;
                     fotter_3=fotter_3+approved_deduplication;
                     fotter_4=fotter_4+total;
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+total_duplicate+"</td><td>"+approval_pending+"</td><td>"+approved_deduplication+"</td><td>"+total+"</td></tr>");
                      //slno++;
