                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3" style="margin-top: 32px;">
                                    ...
                                    <button style="float: right;" type="button" id="submitting" value="Submit"
                                        ...
                                        onclick="window.location.href='{{ route('dup-aadhar-ben-list') }}'"><i
                                            class="fa fa-users"></i> Duplicate Aadhar Info Beneficiary List</button>
        ...
        $(document).ready(function() {
            ...
            $(".exportToExcel").click(function(e) {
                ...
                $(".table2excel").table2excel({
                    ...
                    exclude: ".noExl",
                    name: "Worksheet Name",
                    filename: "Lakshmir Bhandar No Aadhaar Mis Report " +
                        c_time, //do not include extension
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $.each(data.row_data, function(i, item) {
                            var total_duplicate = isNaN(parseInt(item.total_duplicate)) ? 0 : parseInt(
                                item.total_duplicate);
                            var approval_pending = isNaN(parseInt(item.approval_pending)) ? 0 :
                                parseInt(item.approval_pending);
                            //  var approved = isNaN(parseInt(item.approved)) ? 0 : parseInt(item.approved); 
                            var approved_deduplication = isNaN(parseInt(item.approved_deduplication)) ?
                                0 : parseInt(item.approved_deduplication);
                            ...
                            table.append("<tr><td>" + (i + 1) + "</td><td>" + item.location_name +
                                "</td><td>" + total_duplicate + "</td><td>" + approval_pending +
                                "</td><td>" + approved_deduplication + "</td><td>" + total +
                                "</td></tr>");
                            //slno++;
