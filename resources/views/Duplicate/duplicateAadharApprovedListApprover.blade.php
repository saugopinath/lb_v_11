    ...
    <div class="box box-default">
      <div class="box-body">
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><span id="panel-icon"><h4><b>Modified Duplicate Aadhaar(Approved)</b></h4></div>
          ...
          <div class="panel-body" style="padding: 5px; font-size: 14px;">
             ...
             <div class="row">
              ...
              <div class="form-group col-md-offset-3 col-md-3" style="display: none;" id="approve_rejdiv">
                <button type="button" name="bulk_approve" class="btn btn-danger btn-lg" id="bulk_approve" value="approve">
                  Approve</button>
...
<div id="modalApproval" class="modal fade">
  <form method="POST" action="{{ route('dupAadhaarApproved')}}"  name="dupApproved" id="dupApproved">
...
<input type="hidden" name="accept_reject_type" id="accept_reject_type" value="A" />
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Do you really want to <span id="acc_reject">Approved</span> aadhar changes <span id="singleInfo">of the application(<span id="application_text_approve"></span>)</span>?</p>
        <div class="form-group col-md-4">
             <label class="" for="heading">Enter Remarks</label><textarea style="margin: 0px; width: 279px; height: 40px;"
             name="accept_reject_comments" id="accept_reject_comments"></textarea>
             </div>
			</div>
      <br/> <br/> <br/>
