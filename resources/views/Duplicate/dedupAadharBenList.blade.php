...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Aadhar De-Duplicate Pending Beneficiary List
            </h1>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" id="panel_head">List of Aadhar De-Duplication Beneficiaries</div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#excel_btn').click(function() {
                ...
                redirectPost('GetdupAadharBenListExcel', data);
            });
            ...
            dataTable = $('#example').DataTable({
                ...
                "buttons": [{
                        ...
                        title: "Aadhar De-Duplicate Pending Beneficiary List Generated On-@php
