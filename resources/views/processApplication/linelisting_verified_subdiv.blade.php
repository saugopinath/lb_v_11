      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <center><h4 id="dupBankText" style="color:red; display:none;">N.B: Can't verify due to duplicate bank account</h4></center>
          </div>
          <div class="modal-body ben_view_body">
           ...
           <tr>       
           <th scope="row">Duare Sarkar/Samasyaa Samadhan Registration no.</th><td id='duare_sarkar_registration_no'></td>
