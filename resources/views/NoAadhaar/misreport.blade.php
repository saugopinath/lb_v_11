...
@section('content')
    <div class="row mb-1 ml-2">
        <div class="page-header col-sm-auto mt-4">
            <h1 class="page-title">
                <i class="fas fa-exchange-alt"></i> No Aadhaar Mis Report for Approved Benficiary
            </h1>
        </div>
    </div>
                ...
                success: function(data) {
                    ...
                    if (data.return_status) {
                        ...
                        $.each(data.row_data, function(i, item) {
                            ...
                            var action_pending = isNaN(parseInt(item.action_pending)) ? 0 : parseInt(
                                item.action_pending);
                            ...
                            table.append("<tr><td>" + (i + 1) + "</td><td>" + item.location_name +
                                "</td><td>" + total + "</td><td>" + action_pending + "</td><td>" +
                                approval_pending + "</td><td>" + approved + "</td><td>" + rejected +
                                "</td></tr>");
                            //slno++;
