            ...
            <div class="tab-content" style="margin-top:16px;">
             ...
             <div class="tab-pane active" id="personal_details">
              <div class="panel panel-default">
               <div class="panel-heading"><h4><b>No Aadhaar Mis Report for Approved Benficiary</b></h4></div>
...
<div id="divScrool"> 
         ...
         <thead>
              ...
              <th>Total(C)</th> 
              <th>Pending for Action(D)</th> 
              <th>Verified but Approval Pending(E)</th>
              <th>Verified and Approved(F)</th> 
              <th>Rejected(G)</th>
              </tr> 
                ...
                success: function (data) {
                  ...
                  if(data.return_status){
                   ...
                   $.each(data.row_data, function(i, item) {
                     ...
                     var action_pending = isNaN(parseInt(item.action_pending)) ? 0 : parseInt(item.action_pending);
                     ...
                     fotter_2=fotter_2+action_pending;
                     fotter_3=fotter_3+approval_pending;
                     fotter_4=fotter_4+approved;
                     fotter_5=fotter_5+rejected;
                     table.append("<tr><td>"+(i+1)+"</td><td>"+item.location_name+"</td><td>"+total+"</td><td>"+action_pending+"</td><td>"+approval_pending+"</td><td>"+approved+"</td><td>"+rejected+"</td></tr>");
                      //slno++;
