    ...
    <div class="content-wrapper">
          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <div class="box-header with-border">
                <h3 class="box-title"><a href="@if($add_edit_status==1 || $add_edit_status==4){{ url('lb-wcd-search') }} @elseif($add_edit_status==3) {{ url('lb-application-list') }} @else{{ url('lb-application-list') }}@endif" ><img  width="50px;" style="pull-left"  src="{{ asset("images/back.png") }}" alt="Back" /></a>&nbsp<b>Government of West Bengal Lakshmir Bhandar Scheme</b></h3>
      ...
      <ul></ul></div>
            ...
            <li><a data-toggle="tab" href="#list_experience_details">Enclosure List(Self Attested)</a></li> -->
                ...
                <div class="row" >
                     <div class="form-group col-md-4 duareSarkar">
                  ...
                  <div class="row">
                         ...
                         <div class="form-group col-md-4">
                          ...
                          <input type="text" name="sws_card_no" id="sws_card_no" class="form-control NumOnly"
                              placeholder="Swasthyasathi Card No." maxlength="50" value="{{$add_edit_status==1?old('duare_sarkar_registration_no'):$row->duare_sarkar_registration_no }}" tabindex="5" />
                            <span id="error_duare_sarkar_registration_no" class="text-danger"></span>
                        </div>
                         <div class="form-group col-md-4">
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" name="first_name" id="first_name" class="form-control txtOnly"
                            placeholder="First Name" maxlength="200" value="{{$add_edit_status==1?old('first_name'):$row->ben_fname }}" tabindex="5" />
                      ...
                      <div class="row">
                       ...
                       <div class="form-group col-md-4" id="caste_certificate_no_section">
                              <label class="">SC/ST Certificate No.</label>
                  ...
                  <div class="tab-pane" id="bank_details">
                    <div class="panel panel-default">
                      ...
                      <input type="hidden" name="bankCount" id="bankCount" value="{{ $bankCount }}">
                        ...
                        <div class="row">
                        <div class="form-group col-md-6">
                          <label class="">Bank Branch Name</label>
                        ...
                        <div class="form-group col-md-6">
                         ...
                         <div class="row">
<div class="form-group col-md-6">
                          <label class="">Confirm Bank Account Number</label>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                                ...
                                @if(isset($encloser_list))
                                    ...
                                    <div class="form-group col-md-12">
                                    <label class="fileLable">{{ $doc_all['doc_name'] }}</label>
                  ...
                  <div class="tab-pane" id="decl_details">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
              <form name="declaration" id="declaration" method="post" action="{{url('ajax_faulty_declaration_entry')}}">
                        ...
                        <div class="section1">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div align="center">
                                ...
                                <p>
                                  <h2>Lakshmir Bhandar Pension Scheme</h2>
                                </p>
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12" id="spouse_modal">
...
$(document).ready(function(){
  ...
  @if($add_edit_status==3 || $add_edit_status==2)
...
//var error_title ='';
 ...
 if( error_duare_sarkar_registration_no !='' || error_duare_sarkar_date !='' || error_first_name != ''  || error_gender != ''  
  ...
  //if( valid==0 )
  {
   ...
   return false;
     ...
     var data = $.param({"_token": '{{ csrf_token() }}',"application_id":$("#commonfield #application_id").val(),"add_edit_status":$("#commonfield #add_edit_status").val(),"sws_card_no":$("#commonfield #sws_card_no").val(),"source_type":$("#commonfield #source_type").val(), "source_id":$("#commonfield #source_id").val()}) + "&" + $("#personal").serialize();
      $.ajax({
      type: 'post',
      url: '{{ url('ajax_faulty_personal_entry') }}',
      dataType: 'json',
      data: data,
      beforeSend: function(){
        $('#btn_personal_details_loader').show();
 ...
 $("#errorDiv").find("ul").html('');
  ...
  else
  {
     ...
     $.ajax({
      type: 'POST',
      url: '{{ url('ajax_faulty_contact_entry') }}',
      dataType: 'json',
      data: data,
      beforeSend: function(){
        $('#btn_contact_details_loader').show();
 ...
 $("#errorDiv").find("ul").html('');
  ...
  else
  {
     ...
     var data = $.param({"_token": '{{ csrf_token() }}',"application_id":$("#commonfield #application_id").val(),"add_edit_status":$("#commonfield #add_edit_status").val(),"sws_card_no":$("#commonfield #sws_card_no").val(),"source_type":$("#commonfield #source_type").val(), "source_id":$("#commonfield #source_id").val()}) + "&" + $("#bank").serialize();
      $.ajax({
      type: 'POST',
      url: '{{ url('ajax_faulty_bank_entry') }}',
      dataType: 'json',
      data: data,
      beforeSend: function(){
        $('#btn_bank_details_loader').show();
