          ...
          <div class="col-md-12">
            ...
            <div>
              ...
              <div class="box-header with-border">
                <h3 class="box-title"><a href="{{ url('lb-faulty-application-list') }}" ><img  width="50px;" style="pull-left"  src="{{ asset("images/back.png") }}" alt="Back" /></a>&nbsp<b>Government of West Bengal Lakshmir Bhandar Scheme</b></h3>
                ...
                <div class="row" >
                  ...
                  <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          <label class="">Age<span style=""> (as on 02/01/2022)</span></label>
                        ...
                        <div class="section1">
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <div class="modal_field_name" style="margin-right:6%;">Age (as on 02/01/2022):</div>
