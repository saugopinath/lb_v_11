              ...
              <div class="panel panel-default">
               ...
               <div class="row">
                      <div class="form-group col-md-4">
                          ...
                          <span id="" class="text-info"><b>{{$row->ben_fname}} {{$row->ben_mname}} {{$row->ben_lname}}</b></span>
                        </div>
                         <div class="form-group col-md-4">
                          <label class="">Application Id:</label>
                          <span id="" class="text-info"><b>{{$row->application_id}}</b></span>
                        </div>
               ...
               <div class="form-group col-md-3" id="divBodyCode">
                            <label class="required-field">Swasthyasathi Card No.</label>
                              ...
                              placeholder="Swasthyasathi Card No." maxlength="50" 
                               tabindex="11"  autocomplete="off" value="{{$row->ss_card_no}}"/>
