...
<div class="wrapper">
  ...
  <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div> <!-- class="box box-primary" -->
            ...
            <center><p  id="AlreadyImportList" class="alert alert-success">Already Imported List</p></center>
      ...
      <center><p   style="display:none;" id="ImportList" class="alert alert-info">Yet to Imported List</p></center>
