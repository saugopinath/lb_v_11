...
<div class="wrapper">
  ...
  <section class="content">
      ...
      <center><p   style="display:none;" id="ImportList" class="alert alert-info">Changed/Correction data received from Swasthya Sathi</p></center>
      <p   style="display:none;" id="ImportListMsg" class="alert alert-danger"></p>
      <table class="table table-condensed" id="ImportTable" style="display:none;">
        <thead>
          <tr>
                <th width="20%">Applicant Name</th>
                <th width="20%">Father's Name</th>
...
function importData (sws_card_no,slno) {
 var y_n=confirm('Are You Sure .You Want to Import It?');
 if(y_n){
  $("#impotrId_"+slno).hide();
  jQuery.ajax({
                                  ...
                                  success: function(result){
                                    if(result.isValid==1){
                                      loadDatatable();
                                          $("#impotrId_"+slno).text('NA');
                                          $("#ImportListMsg").show();
                                          $("#ImportListMsg").text(result.Msg);
                                    }
                                    else{
                                      $("#ImportListMsg").show();
                                      $("#ImportListMsg").text(result.errorMsg);
                                    }
