...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h1>Name Mismatch Validation Report</h1>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="card-body">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title">Search By District</h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3" style="margin-top: 26px;">
                                    ...
                                    <button type="button" name="excel_btn" id="excel_btn" class="btn btn-primary ms-2">
                                        <i class="fa fa-file-excel-o"></i> Get Excel
                                    </button>

                                    <button type="button" name="reset" id="reset" class="btn btn-warning ms-2">
                                        Reset
                                    </button>
                                </div>
                ...
                <div class="table-responsive resultDiv mt-3" id="validation_lot_div">
                    <table id="tableForNameValidation" class="data-table"
                           cellspacing="0" width="100%" style="border: 1px solid ghostwhite;">
