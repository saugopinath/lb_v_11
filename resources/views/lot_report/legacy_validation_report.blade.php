...
@section('content')
    ...
    <section class="content-header">
        <h1>Districtwise Legacy Validation Report</h1>
    </section>
    <div class="card card-primary card-outline">
        <div class="card-body">
            ...
            <div class="table-responsive resultDiv" id="validation_lot_div">
                ...
                <table id="tableForValidation" class="data-table" style="border: 1px solid ghostwhite;">
                    ...
                    <thead style="font-size: 12px;" class="table-light">
                        <tr>
                            ...
                            <th>SC Success</th>
                            <th>ST Success</th>
                            <th>Validation <br>Response Pending <br>From Bank</th>
                            <th>Naming Failed</th>
                        </tr>
                    </thead>
...
@push("scripts")
    <script>
        $(document).ready(function () {
            ...
            $('.sidebar-menu #LegacylotValidationReport').addClass("active");
        ...
        $(document).ready(function () {
            ...
            var table = $('#tableForValidation').DataTable({
                ...
                ajax: {
                    url: "{{ route('legacyValidationLotReport') }}",
                    type: "POST",
                    data: function (d) {
