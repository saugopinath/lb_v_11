        ...
        <div class="row mb-2">
            <div class="col-sm-10">
                <h1>
                    ...
                    <span class="fs-6">(Based on the Lot Pushed date to the bank)</span>
                </h1>
            </div>
        </div>
    </div>
                ...
                buttons: [
                    {
                        extend: 'pdfHtml5',
                        //  extend: 'pdf',
                        title: "Monthly Disbursement Report @php date_default_timezone_set('Asia/Kolkata');
                    ...
                    {
                        extend: 'excel',
                        title: "Monthly Disbursement Report Generated On-@php date_default_timezone_set('Asia/Kolkata');
                            $date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));
                            $date = $date->format('F j, Y g:i:a');
                        echo $date;@endphp ",
