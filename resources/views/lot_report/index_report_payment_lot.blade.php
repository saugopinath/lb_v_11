            ...
            <div class="table-responsive resultDiv" id="payment_div" style="display: none;">
              <table id="tableForPayment" class="table table-bordered display" cellspacing="0" width="100%" style="border: 2px solid ghostwhite;">
                <thead style="font-size: 12px;">
                  <tr role="row">
                    <th colspan="1">District[A]</th><th colspan="4">Beneficiary Record[B]</th><th colspan="10">Payment Status[C]</th><th colspan="4">Rejected[D]</th>
                    <th colspan="4">Payment Awaited[E]</th>
                    <th colspan="4">Amount[F]</th>
                  </tr>
                  <tr role="row">
                  <th>District Name<br><span style="font-weight: normal;">[1]</span></th>
                  <th>Total Beneficiary <br><span style="font-weight: normal;">[2=3+4+5]/ [2=6+16+ 17+18+19+20+ 21+22+23]</span></th>
                  ...
                  {{-- <th>Total Amount <br><span style="font-weight: normal;">[6]</span></th>
                  <th>SC Amount <br><span style="font-weight: normal;">[7]</span></th>
                  <th>ST Amount <br><span style="font-weight: normal;">[8]</span></th>
                  <th>Others Amount <br><span style="font-weight: normal;">[9]</span></th> --}}
                  ...
                  <th>Send To Bank <br><span style="font-weight: normal;">[8=9+10+11]</span></th>
                  ...
                  <th>Response Received <br><span style="font-weight: normal;">[12=13+14+15]</span></th>
                  ...
                  <th>Age Above 60 Years[Included Previous Months] <br><span style="font-weight: normal;">[16]</span></th>
                  ...
                  <th>Validation Failure/Previous Payment Failure/<br>Validation Lot Not Generated/<br>Validation Response Pending<br><span style="font-weight: normal;">[23]</span></th>





                  <th>Send To Bank Amount <br><span style="font-weight: normal;">[24=25+26+27]</span></th>
                ...
                <tfoot style="font-size: 14px; font-weight: bold; text-align: right;"><tr>
...
"footerCallback": function ( row, data, start, end, display ) {
  ...
  buttons: [
    {
      extend: 'pdfHtml5',
      title: "Payment  Report- District Wise @php date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ;@endphp",
