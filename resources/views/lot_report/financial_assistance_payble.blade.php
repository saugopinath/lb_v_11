              ...
              <table id="example" class="table table-bordered table-hover display table2excel"  cellspacing="0">
                <thead style="font-size: 12px;">
                  <tr>
                    ...
                    <th colspan="2" style="text-align: center;">Bank Account Validation Pending</th>
                    <th colspan="4" style="text-align: center;">Application Approval Pending</th>
                  </tr>
                  <tr>
                    ...
                    <!-- <th>Financial <br>assistance <br>payable (Rs.)<br>[7]</th> -->
                    <!-- <th>Assistance <br>payable for <br>no. of months<br>[8]</th> -->
