...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Date Wise Lot Report <span style="font-size: 16px;">(Based on the Lot Creation date)</span>
    </h1>
    {{-- <ol class="breadcrumb">
        ...
        <!-- </div> -->
            ...
            <div class="table-responsive resultDiv" id="validation_lot_div">
              <table id="tableForLot" class="display" cellspacing="0" style="width:100%; border: 1px solid ghostwhite;">
                ...
                <tfoot style="font-size: 14px; font-weight: bold; "><tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr></tfoot>
              </table>
            </div>
          <!-- </div>
        </div> -->
  ...
  $(document).ready(function(){
	...
	'columnDefs': [
        ...
        buttons: [
       {
        extend : 'pdfHtml5',
        //  extend: 'pdf',
        title: "Date Wise Lot  Report @php date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ;@endphp",
       ...
       {
          extend: 'excel',
          title: "Date Wise Lot  Report Generated On-@php date_default_timezone_set('Asia/Kolkata');$date = \Carbon\Carbon::createFromFormat('F j, Y g:i:a', date('F j, Y g:i:a'));$date = $date->format('F j, Y g:i:a'); echo    $date ;@endphp ",
