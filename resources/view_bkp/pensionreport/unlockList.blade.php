  ...
  @section('action-content')
      ...
      <section class="content">
        ...
        <div class="box-body">
				...
				<center>	<h4><span class="label label-primary">{{$report_type_name}}</span></h4></center>
			...
			<div class="modal-dialog ">
				<div class="modal-content">
					<div class="modal-header btn-info">
						...
						<h4 class="modal-title">Approve Pending Unlock Beneficiary Details</h4>
					</div>
					<div class="modal-body">
						<h4>Are you sure you want to approve pending unlock beneficiary details mentioned below?</h4><hr/>
              ...
              <tr>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-info" id="unlock_submit_button" data-dismiss="modal">Approve Unlock Request</button>
					</div>
				</div>
			</div>
		</div>
  ...
  $(document).ready(function(){ 
    ...
    $('.sidebar-menu #unlockList').addClass("active");         
  ...
  $('#unlock_submit_button').click(function(e){
    ...
    $("#unlock_"+ben_id).html('');
    $("#unlock_"+ben_id).html('<img src="{{ asset('images/ZKZg.gif') }}" width="50px" height="50px"/>');
    $.ajax({
      type: 'get',
      dataType: 'json',
      url: '{{ url('benUnlockApprove') }}',
      data: {
        ben_id: ben_id,
        _token: '{{ csrf_token() }}',
      },
