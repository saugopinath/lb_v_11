  ...
  public function updateStopPaymentFinal(Request $request)
  {
    ...
    if ($is_valid == 1) {
      try {
        ...
        $updateBenPersonalDetails = ['action_by' => Auth::user()->id,'action_ip_address' => request()->ip(),'action_type' => class_basename(request()->route()->getAction()['controller']),'next_level_role_id' => -99];
