...
trait TraitLifeCertificateValidate {
 ...
 protected $clientSecre2 = '107deddc0bed7533c7debd52d8fb01de37d795fd293334dd11b17bda2b6fff72394229ece8409ec5256da7b6645ae69dd30261514a6279cebda58393fa3b7303';
   ...
   public function bioauthcheckInsert($distCode,$application_id,$ben_fullname,$ip,$aadhar_no,$blockCode,$user_id,$api_code){
    // dd($ben_fullname);
    ...
    $lifecertificate_validation_arr['application_id']=$application_id;
    ...
    $insert=DB::table('lb_scheme.ben_lc_api_response_track')->insert($lifecertificate_validation_arr);
