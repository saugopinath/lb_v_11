...
!(function (t) {
    ...
    (p = t.cleanData),
        ...
        (t.widget.extend = function (e) {
            for (
                var i, s, a = o.call(arguments, 1), r = 0, l = a.length;
                r < l;
                r++
            )
                for (i in a[r])
                ...
                return (
                    a
                        ? this.length || "instance" !== n
                            ...
                            : (l = void 0)
                        : (r.length &&
                              (n = t.widget.extend.apply(null, [n].concat(r))),
                          this.each(function () {
                              var e = t.data(this, s);
                              e
        ...
        (t.ui.formResetMixin = {
            ...
            _bindFormResetHandler: function () {
                if (
                    ((this.form = t(this.element.prop("form"))),
                    this.form.length)
                ) {
    ...
    t(document).on("mouseup", function () {
        ...
        t.widget("ui.resizable", t.ui.mouse, {
            ...
            _mouseStart: function (e) {
                ...
                return (
                    ...
                    this._helper ||
                        (o = this._calculateAdjustedElementDimensions(r)),
                    ...
                    this._helper &&
                        ...
                        (r =
                            parseFloat(this.element.css("left")) +
                                (this.position.left -
                                    this.originalPosition.left) || null),
                        (l =
                            parseFloat(this.element.css("top")) +
                                (this.position.top -
                                    this.originalPosition.top) || null),
                        h.animate ||
            ...
            _calculateAdjustedElementDimensions: function (t) {
                ...
                return "content-box" === t.css("box-sizing") &&
                    ...
                    ? ((e = parseFloat(n.style.width)),
                      ...
                      (e = isNaN(e)
                          ? this._getElementTheoreticalSize(t, s, "width")
                          : e),
                      {
                          height: (i = isNaN(i)
        ...
        t.widget("ui.autocomplete", {
            ...
            _create: function () {
                ...
                (this.isMultiLine =
                    o ||
                    (!a && "true" === this.element.prop("contentEditable"))),
    ...
    t.widget("ui.controlgroup", {
            ...
            t.ui.formResetMixin,
            {
                ...
                _getCreateOptions: function () {
                    ...
                    return (
                        ...
                        (this.originalLabel = ""),
                        (s = this.label.contents().not(this.element[0]))
                            .length &&
            ...
            _generateHTML: function (e) {
                ...
                for (
                    e.drawMonth = tt,
                        ...
                        u = isNaN((u = parseInt(this._get(e, "firstDay"), 10)))
                            ? 0
                            : u,
                    ...
                    for (D = 0, C = "", this.maxRows = 4; D < V[1]; D++) {
                        ...
                        for (
                            P += M + "</tr></thead><tbody>",
                                ...
                                O = Math.ceil(
                                    ((z =
                                        (this._getFirstDayOfMonth(te, tt) -
                                            u +
                                            7) %
                                        7) +
                                        H) /
                            ...
                            for (
                                ...
                                (F = _
                                    ? _.apply(e.input ? e.input[0] : null, [E])
                                    : [!0, ""]),
                                    (R =
                                        ((L = E.getMonth() !== tt) && !b) ||
                                        !F[0] ||
            ...
            _makeResizable: function () {
                ...
                this.uiDialog
                    .resizable({
                        ...
                        handles:
                            "string" == typeof s ? s : "n,e,s,w,se,sw,ne,nw",
                        start: function (i, s) {
        ...
        t.widget("ui.slider", t.ui.mouse, {
            ...
            _values: function (t) {
                ...
                for (
                    s = 0, i = this.options.values.slice();
                    s < i.length;
                    s += 1
                )
        ...
        t.widget("ui.spinner", {
            ...
            _adjustValue: function (t) {
                ...
                return ((i =
                    Math.round(
                        (i = t - (e = null !== s.min ? s.min : 0)) / s.step
                    ) * s.step),
            ...
            _processTabs: function () {
                ...
                (this.tablist = this._getList().attr("role", "tablist")),
                    ...
                    this.anchors.each(function (i, s) {
                        ...
                        e._isLocal(s)
                            ? ((a = (n = decodeURIComponent(s.hash)).substring(
                                  1
                              )),
                    ...
                    t.extend(t.effects, {
                        save: function (t, e) {
                            for (var i = 0, s = e.length; i < s; i++)
                                null !== e[i] &&
                                    t.data(z + e[i], t[0].style[e[i]]);
                        },
                        restore: function (t, e) {
                            for (var i, s = 0, n = e.length; s < n; s++)
                                null !== e[s] &&
                                    ((i = t.data(z + e[s])), t.css(e[s], i));
                        },
